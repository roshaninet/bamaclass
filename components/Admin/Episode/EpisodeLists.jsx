...
const EpisodeForm = dynamic(() => import('./EpisodeForm'), {
    ssr: false
});
...
class EpisodeLists extends BaseClass {
    constructor(props) {
        super(props);
        this.state.title = 'قسمت ها';
        this.state.path = 'episodes';
        this.state.standAlone = true;
        this.state.redirectParams = props.parameters?.curseIndexId ? {
            curseIndexId:  props.parameters?.curseIndexId
        } : null
    }
    ...
    render() {
        return (
            <ContainerContent
                ...
                abs={this.addButton()}
                left={this.state.params?.curseIndexId ? <BackButton/> : null}
...
EpisodeLists.propTypes = {
    results: PropTypes.object,
    parameters: PropTypes.object
}


export default withRouter(EpisodeLists);