...
const IndexForm = dynamic(() => import('./IndexForm'), {
    ssr: false
});

const IndexCard = dynamic(() => import('./IndexCard'), {
    ssr: false
});

class IndexLists extends BaseClass {
    constructor(props) {
        super(props);
        this.state.title = 'سر فصل ها';
    ...
    render() {
        return (
            <ContainerContent
                ...
                abs={this.props.parameters.curseId && this.addButton()}
                left={this.state.params?.curseId ? <BackButton/> : null}
                ...
                <ModalDialog size='lg' title={this.state.title} className="modal-pretty-head" show={this.state.show}
                    ...
                    <IndexForm
                        curseId={this.props.parameters.curseId}
...
IndexLists.propTypes = {
    results: PropTypes.object,
    parameters: PropTypes.object
}


export default withRouter(IndexLists);